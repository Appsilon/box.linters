...
get_attached_packages <- function(xml) {
  ...
  xpath_package_import <- paste(box_base_xpath(), box_package_import)
...
"
  xpath_whole_packages <- paste(box_base_xpath(), whole_package_imports)
...
get_attached_pkg_three_dots <- function(xml) {
  ...
  xpath_package_three_dots <- paste(box_base_xpath(), box_package_three_dots)
...
"
  xpath_package_functions <- paste(box_base_xpath(), xpath_package_functions)
